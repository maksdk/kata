...
describe('Phonebook', () => {
    describe('Server', () => {
        ...
        it('GET /search?q=<substr>', (done) => {
            const expected = [{
                    name: 'Miss Lindsey Hermann',
                    phone: '1-559-706-3580'
                },
                {
                    name: 'Miss Herman Orn',
                    phone: '988-099-6371'
                },
                {
                    name: 'Ms. Liana Herman',
                    phone: '(422) 346-7454'
                },
                {
                    name: 'Herman Oberbrunner',
                    phone: '315-607-3728'
                },
            ];
        ...
        it('/users.json', async (done) => {
            const result = {
                ...
                data: [{
                        name: 'Chelsie Eichmann',
                        phone: '1-466-807-1978'
                    },
                    {
                        name: 'Miss Ewald Dickinson',
                        phone: '699-653-9379'
                    },
                    {
                        name: 'Mauricio Cassin',
                        phone: '(683) 115-8139'
                    },
                ],
            };
        ...
        it('/users.json?perPage&page', async (done) => {
            const result = {
                ...
                data: [{
                    ...
                    {
                        name: 'Mrs. Mabelle Cormier',
                        phone: '307.095.4754'
                    },
                    {
                        name: 'Kale Macejkovic',
                        phone: '699-803-8578'
                    },
                    {
                        name: 'Miss Verla West',
                        phone: '(546) 173-8884'
                    },
                ],
            };
